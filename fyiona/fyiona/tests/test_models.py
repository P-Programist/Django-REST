...
def test_user_create():
    count_of_users =  users_models.CustomUser.objects.count()
    users_models.CustomUser.objects.create_user(
        email="test@gmail.com",
        first_name="Azatot",
        last_name="Nirlatotep",
        phone_number=None,
    )
    assert users_models.CustomUser.objects.count() == count_of_users + 1
    users_models.CustomUser.objects.create_user(
    ...
    assert users_models.CustomUser.objects.count() == count_of_users + 2