...
CSRF_TRUSTED_ORIGINS = ['https://www.backend.fyiona.com', 'https://backend.fyiona.com']


CORS_ORIGIN_WHITELIST = (
    'https://www.backend.fyiona.com',
    'https://www.backend.fyiona.com:80',

    'https://backend.fyiona.com',
    'https://backend.fyiona.com:80'
)
